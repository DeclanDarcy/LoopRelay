...
| Architectural regression framework | 0.3 | Backend architecture-test namespace, mechanism catalog, fixture-wiring meta-regression, architectural invariant catalog, catalog metadata regression, regression taxonomy, ownership and severity seed | Initial M0.3 skeleton verified locally in Slice 0036; invariant catalog guard verified locally in Slice 0037 | `docs/architectural-mechanisms.md` | In progress; invariant catalog installed and guarded, confidence model, frontend regression area, shell regression classification, and certification remain pending |
