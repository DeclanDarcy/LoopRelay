...
| Canonical contract model | 1.1 | Contract identity model and initial identity inventory in `.agents/milestones/m1.1-contract-identity-inventory-slice-0059.md`; contract taxonomy, projection-contract relationship model, ownership matrix, and consumer model in `.agents/milestones/m1.1-contract-taxonomy-ownership-slice-0060.md`; contract stability model, normalization rules, and boundary semantics in `.agents/milestones/m1.1-contract-normalization-boundaries-slice-0061.md`; contract evolution operations, compatibility states, and governance sequence in `.agents/milestones/m1.1-contract-evolution-compatibility-governance-slice-0062.md`; canonical family conformance examples in `.agents/milestones/m1.1-canonical-contract-examples-slice-0063.md`; model-complete certification review in `.agents/milestones/m1.1-canonical-contract-model-certification-slice-0064.md`; acceptance baseline in `.agents/milestones/m1.1-canonical-contract-model-acceptance-baseline-slice-0065.md` | Locally certified in Slice 0064 as a model-complete canonical contract foundation for M1.2 generation; accepted and baselined in Slice 0065 as the M1.2 model boundary | `docs/contracts.md` | Accepted and baselined; M1.1 defines identity, taxonomy, projection-contract relationship, ownership, consumer classes, stability, normalization, boundary semantics, evolution, compatibility, governance, and canonical examples without introducing generation or consumer migration |
| Generated contract ecosystem | 1.2 | Repository dashboard generation-pipeline pilot in `.agents/milestones/m1.2-generated-contract-pipeline-validation-slice-0068.md`; raw TypeScript alias validation in `.agents/milestones/m1.2-generated-raw-typescript-alias-slice-0069.md`; generated TypeScript consumer policy in `.agents/milestones/m1.2-generated-typescript-consumer-policy-slice-0070.md`; governed schema metadata pilot in `.agents/milestones/m1.2-repository-dashboard-schema-metadata-pilot-slice-0071.md`; production-consumer candidate verification in `.agents/milestones/m1.2-repository-dashboard-production-consumer-candidate-slice-0073.md`; compatibility-wrapper bridge in `.agents/milestones/m1.2-repository-dashboard-compatibility-wrapper-bridge-slice-0074.md`; dev Tauri mock bridge in `.agents/milestones/m1.2-repository-dashboard-dev-tauri-mock-bridge-slice-0075.md`; `ContractGeneratedArtifactPipelineTests`; canonical generated IR `repository-dashboard.contract-ir.json`; generated TypeScript contract artifact `src/LoopRelay.UI/src/contracts/generated/repository-dashboard.generated.ts`; generated alias and candidate consumer verification; generated artifact freshness manifest `repository-dashboard.generated-artifact-freshness.json` | Slice 0068 locally verifies Oracle fixture -> IR -> generated TypeScript metadata determinism and generated artifact freshness for one pilot family; Slice 0069 locally verifies raw generated TypeScript aliases against the Oracle fixture; Slice 0070 defines schema/nullability and semantic alias policy before production consumer migration; Slice 0071 carries governed schema facts into the generated IR and TypeScript metadata for selected production-migration blockers; Slice 0073 emits a generated production-consumer candidate and verifies structural and semantic compatibility against the manual wrapper; Slice 0074 bridges the production dashboard compatibility wrapper to the generated candidate through the existing `src/types` import boundary and verifies backend contracts plus UI build/lint/tests; Slice 0075 types the repository-dashboard dev mock dashboard entry against the generated candidate and verifies the bridge plus UI build | `docs/contracts.md` | In progress; generation pipeline validation, raw alias verification, consumer migration policy, governed schema metadata, a verified production-consumer candidate, a wrapper-mediated production dashboard bridge, and a generated-candidate-typed mock bridge exist for `repository-dashboard`, but generated mock output, Rust metadata verification, versioning, and compatibility wrapper retirement remain pending |
...
- backend architecture-test namespace under `tests/LoopRelay.Backend.Tests/Architecture`,
...
- frontend architecture-test area under `src/LoopRelay.UI/src/test/architecture`,
...
- shell Rust struct classification guard that keeps `src/LoopRelay.Shell/src/main.rs` aligned with `docs/shell-transport-classification.md`,
...
Slice 0052 adds executable shell mirror governance by requiring every Rust struct in `src/LoopRelay.Shell/src/main.rs` to appear in the Rust Mirror Inventory and every inventory entry to remain present in code. It does not classify whether an allowed mirror is passive, compatibility, or shell-owned correctly beyond the existing inventory metadata.
