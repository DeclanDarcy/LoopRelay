...
| Canonical contract model | 1.1 | Contract identity model and initial identity inventory in `.agents/milestones/m1.1-contract-identity-inventory-slice-0059.md`; contract taxonomy, projection-contract relationship model, ownership matrix, and consumer model in `.agents/milestones/m1.1-contract-taxonomy-ownership-slice-0060.md`; contract stability model, normalization rules, and boundary semantics in `.agents/milestones/m1.1-contract-normalization-boundaries-slice-0061.md` | Not certified; M1.1 has identity, taxonomy, ownership, consumer, stability, normalization, and boundary semantics documentation, but evolution, compatibility, governance, canonical examples, and certification remain pending | `docs/contracts.md` | In progress; identity is defined for the three Phase 0 Oracle pilots, taxonomy/ownership classify M1.1 contract categories, and normalization/boundary rules now constrain later generation without introducing generation or consumer migration |
