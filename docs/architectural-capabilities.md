...
| Canonical contract model | 1.1 | Contract identity model and initial identity inventory in `.agents/milestones/m1.1-contract-identity-inventory-slice-0059.md` | Not certified; M1.1 has started with identity inventory only | `docs/contracts.md` | In progress; identity is defined for the three Phase 0 Oracle pilots, while taxonomy, ownership, normalization, boundary semantics, evolution, compatibility, governance, and broader examples remain pending |
