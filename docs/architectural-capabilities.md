...
| Generated contract ecosystem | 1.2 | Repository dashboard generation-pipeline pilot in `.agents/milestones/m1.2-generated-contract-pipeline-validation-slice-0068.md`; raw TypeScript alias validation in `.agents/milestones/m1.2-generated-raw-typescript-alias-slice-0069.md`; `ContractGeneratedArtifactPipelineTests`; canonical generated IR `repository-dashboard.contract-ir.json`; generated TypeScript contract artifact `src/CommandCenter.UI/src/contracts/generated/repository-dashboard.generated.ts`; generated alias consumer verification; generated artifact freshness manifest `repository-dashboard.generated-artifact-freshness.json` | Slice 0068 locally verifies Oracle fixture -> IR -> generated TypeScript metadata determinism and generated artifact freshness for one pilot family; Slice 0069 locally verifies raw generated TypeScript aliases against the Oracle fixture; no production consumer migration certified yet | `docs/contracts.md` | In progress; generation pipeline validation and raw alias verification exist for `repository-dashboard`, but schema-complete generated consumer types, mock generation, Rust metadata verification, versioning, and production consumer migration remain pending |
