...
| Generated contract ecosystem | 1.2 | Repository dashboard generation-pipeline pilot in `.agents/milestones/m1.2-generated-contract-pipeline-validation-slice-0068.md`; raw TypeScript alias validation in `.agents/milestones/m1.2-generated-raw-typescript-alias-slice-0069.md`; generated TypeScript consumer policy in `.agents/milestones/m1.2-generated-typescript-consumer-policy-slice-0070.md`; governed schema metadata pilot in `.agents/milestones/m1.2-repository-dashboard-schema-metadata-pilot-slice-0071.md`; `ContractGeneratedArtifactPipelineTests`; canonical generated IR `repository-dashboard.contract-ir.json`; generated TypeScript contract artifact `src/CommandCenter.UI/src/contracts/generated/repository-dashboard.generated.ts`; generated alias consumer verification; generated artifact freshness manifest `repository-dashboard.generated-artifact-freshness.json` | Slice 0068 locally verifies Oracle fixture -> IR -> generated TypeScript metadata determinism and generated artifact freshness for one pilot family; Slice 0069 locally verifies raw generated TypeScript aliases against the Oracle fixture; Slice 0070 defines schema/nullability and semantic alias policy before production consumer migration; Slice 0071 carries governed schema facts into the generated IR and TypeScript metadata for selected production-migration blockers; no production consumer migration certified yet | `docs/contracts.md` | In progress; generation pipeline validation, raw alias verification, consumer migration policy, and a governed schema metadata pilot exist for `repository-dashboard`, but schema-complete generated consumer types, mock generation, Rust metadata verification, versioning, and production consumer migration remain pending |
