...
| Canonical contract model | 1.1 | Contract identity model and initial identity inventory in `.agents/milestones/m1.1-contract-identity-inventory-slice-0059.md`; contract taxonomy, projection-contract relationship model, ownership matrix, and consumer model in `.agents/milestones/m1.1-contract-taxonomy-ownership-slice-0060.md` | Not certified; M1.1 has identity, taxonomy, ownership, and consumer model documentation, but normalization, boundary semantics, evolution, compatibility, governance, and broader examples remain pending | `docs/contracts.md` | In progress; identity is defined for the three Phase 0 Oracle pilots, and taxonomy/ownership now classify the M1.1 contract categories without introducing generation or consumer migration |
