...
| Architectural regression framework | 0.3 | Backend architecture-test namespace, mechanism catalog, fixture-wiring meta-regression, regression taxonomy, ownership and severity seed | Initial M0.3 skeleton verified locally in Slice 0036 | `docs/architectural-mechanisms.md` | In progress; backend skeleton installed, broad invariant catalog and certification remain pending |
...
- initial regression taxonomy, ownership, severity, drift, and UX rules in `docs/architectural-mechanisms.md`.

This is not full M0.3 certification. The broad invariant catalog, confidence model, frontend regression area, shell regression classification, and milestone-level certification remain pending.
