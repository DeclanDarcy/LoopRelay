...
| Generated contract ecosystem | 1.2 | Repository dashboard generation-pipeline pilot in `.agents/milestones/m1.2-generated-contract-pipeline-validation-slice-0068.md`; `ContractGeneratedArtifactPipelineTests`; canonical generated IR `repository-dashboard.contract-ir.json`; generated TypeScript metadata `src/CommandCenter.UI/src/contracts/generated/repository-dashboard.generated.ts`; generated artifact freshness manifest `repository-dashboard.generated-artifact-freshness.json` | Slice 0068 locally verifies Oracle fixture -> IR -> generated TypeScript metadata determinism and generated artifact freshness for one pilot family; no consumer migration certified yet | `docs/contracts.md` | In progress; generation pipeline validation exists for `repository-dashboard`, but full generated consumer types, mock generation, Rust metadata verification, versioning, and consumer migration remain pending |
