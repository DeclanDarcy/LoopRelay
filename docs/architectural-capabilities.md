...
| Architectural regression framework | 0.3 | Backend architecture-test namespace, mechanism catalog, fixture-wiring meta-regression, architectural invariant catalog, catalog metadata regression, regression taxonomy, taxonomy metadata regression, ownership and severity seed | Initial M0.3 skeleton verified locally in Slice 0036; invariant catalog guard verified locally in Slice 0037; regression taxonomy guard verified locally in Slice 0038 | `docs/architectural-mechanisms.md` | In progress; invariant catalog and regression taxonomy are installed and guarded, confidence model, frontend regression area, shell regression classification, and certification remain pending |
