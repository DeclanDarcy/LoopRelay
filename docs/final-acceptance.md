...
| FA-3 | Write Plan uses the correct generated prompt; creates `.agents/plan.md` | met | `BuildWritePlan` selects `WritePlanForNewCodebase.Text`/`WritePlanAgainstCodebase.Text` by `NewCodebase`; `FinishPlanningTurnAsync` verifies `plan.md` |
