...
| `failure-oracle-matrix` | Deterministic audit | workspace | Audits transition recovery coverage, oracle controls, and exclusions. Maintained failure classes are recorded as documentation, not verified. | `failure-oracle-matrix.latest.json` |
