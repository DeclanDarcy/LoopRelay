...
public sealed class LoopRelayCompositionRootTests
{
    [Fact]
    ...
    private static WorkflowControllerRequest ControllerRequest(
    ...
    private static async Task AssertEffectStateAsync(
        Repository repository,
    ...
    private static async Task AssertCanonicalRecoveryPlanAsync(
        Repository repository,
    ...
    private static string ReadCompositionSource(string repositoryRoot)
    {
