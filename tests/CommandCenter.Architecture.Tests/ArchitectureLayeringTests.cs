...
namespace CommandCenter.Architecture.Tests;
...
public sealed class PromptAuthorityTests
{
    ...
    private static readonly string[] CanonicalPromptMarkers =
    {
        ...
        "the epic and specs will be deleted after certifying the plan, the plan must be self-contained",
        "write .agents/plan.md to implement the epic and specs in .agents/specs/ against the current codebase",
