...
public class OneShotStepsTests
{
    ...
    private static (Cli.SandboxedPromptStep Step, FakeAgentRuntime Rt, FakeSandboxWorkspaceFactory Sandboxes, MemoryArtifactStore Store, Cli.PlanArtifacts Artifacts, Repository Repo) NewPipeline()
    {
        ...
        return (new Cli.SandboxedPromptStep(rt, sandboxes, artifacts, con, repo), rt, sandboxes, store, artifacts, repo);
    }
    ...
    public async Task CollectDetailsAsync_BuildsExpectedPlan_SeedingAllSpecsAndPlan_RequiringAndCopyingBackDetailsOnly()
    {
        ...
        Cli.SandboxedStepPlan plan = await Cli.OneShotSteps.CollectDetailsAsync(artifacts);
    ...
    public async Task CollectDetails_EndToEnd_SeedsSpecsAndPlanAtPrefixStrippedPaths_AndCopiesBackDetails()
    {
        ...
        Cli.SandboxedStepPlan collectDetails = await Cli.OneShotSteps.CollectDetailsAsync(artifacts);
    ...
    public async Task ExtractMilestonesAsync_BuildsExpectedPlan_SeedingOnlyPlan_RequiringGlobAndChangedGuard()
    {
        ...
        Cli.SandboxedStepPlan plan = await Cli.OneShotSteps.ExtractMilestonesAsync(artifacts);
    ...
    public async Task ExtractMilestones_EndToEnd_SeedsPlanOnly_RewritesPlan_AndCopiesBackPlanPlusMilestones()
    {
        ...
        Cli.SandboxedStepPlan extractMilestones = await Cli.OneShotSteps.ExtractMilestonesAsync(artifacts);
    ...
    public async Task ExtractDetailsAsync_BuildsExpectedPlan_SeedingDetailsAndAllMilestones_NoChangedGuard()
    {
        ...
        Cli.SandboxedStepPlan plan = await Cli.OneShotSteps.ExtractDetailsAsync(artifacts);
    ...
    public async Task ExtractDetails_EndToEnd_SeedsDetailsAndMilestones_AndCopiesBackBoth()
    {
        ...
        Cli.SandboxedStepPlan extractDetails = await Cli.OneShotSteps.ExtractDetailsAsync(artifacts);
