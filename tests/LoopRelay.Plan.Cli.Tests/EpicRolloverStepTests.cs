...
public class EpicRolloverStepTests
{
    ...
    private static Harness New()
    {
        ...
        return new Harness(new Cli.EpicRolloverStep(runner, artifacts, console, repo), runner, store, repo, console);
    }
    ...
    public async Task TryArchiveAsync_NonZeroExit_Throws_WithExitCodeAndStderr()
    {
        ...
        var ex = await Assert.ThrowsAsync<Cli.PlanStepException>(
