...
public sealed class DecisionSessionEndToEndFixtureTests
{
    ...
    public async Task EndToEndLifecycleFixturePassesThroughWorkflowConsumptionAndCertification()
    {
        ...
        WorkflowDecisionSessionProjection workflowProjection = await workflow.ProjectAsync(harness.Repository.Id);
        ...
        Assert.Equal(fixture.ReplacementSessionId?.ToString(), workflowProjection.DecisionSessionId);
        Assert.Equal(fixture.ContinuityArtifactId, workflowProjection.ContinuityArtifactId);
