...
/// <list type="number">
///   <item>NONE of the three deleted derivation hosted services (decision-session recovery, workflow recovery,
///   workflow continuation) may be registered as an <see cref="IHostedService"/> any longer — their bodies now
...
public sealed class HostedServiceStartupGuardTests
{
    ...
    public void No_per_repo_derivation_hosted_service_is_registered()
    {
        ...
        // The three derivation hosted services are deleted; none may survive as an IHostedService. (Their types no
