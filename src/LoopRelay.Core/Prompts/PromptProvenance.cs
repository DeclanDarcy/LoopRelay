namespace LoopRelay.Core.Prompts;

/// <summary>
/// The Codex session role a rendered prompt was issued under. Mirrors
/// <c>LoopRelay.Agents.Models.SessionRole</c> (same members, same order) but is redeclared
...
/// <summary>
/// Per-turn provenance for a prompt rendered from the <c>LoopRelay.Core.Prompts</c> catalog.
...
public sealed record PromptProvenance
{
    ...
    /// <summary>The generated catalog type's full name, e.g. <c>LoopRelay.Core.Prompts.StartExecution</c>.</summary>
