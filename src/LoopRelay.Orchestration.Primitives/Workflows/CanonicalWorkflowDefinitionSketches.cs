...
internal static class CanonicalWorkflowDeclarations
{
            ...
            [
                ...
                Transition(
                    ...
                    [
                        ...
                        Effect("publish-traditional-plan-entry", EffectCategory.Publication,
                            [preparedEpic.Identity, specs.Identity],
                            [roadmapContext.Identity, selection.Identity, preparedEpic.Identity, specs.Identity],
                            order: 1),
                    ],
                    [
                        ProductDependency(ProductIdentity.PreparedEpic, createEpic, verifyPlanEntry),
    ...
    public static WorkflowDefinition CreateEvalRoadmap()
    {
        ...
        return new WorkflowDefinition(
            ...
            [
                ...
                Transition(workflow, createEpic, "Create and publish prepared epic from next epic roadmap evidence.", [Requirement(ProductIdentity.NextEpicRoadmap)], "CreateNextEpicImplementationSpec", ExecutionPosture.OneShotAgentPrompt, [preparedEpic], [ProductIdentity.PreparedEpic], [Effect("persist-eval-prepared-epic", EffectCategory.ProductPersistence, [ProductIdentity.NextEpicRoadmap], [ProductIdentity.PreparedEpic]), Effect("publish-eval-prepared-epic", EffectCategory.Publication, [ProductIdentity.PreparedEpic], [ProductIdentity.PreparedEpic], order: 1)], [ProductDependency(ProductIdentity.NextEpicRoadmap, createRoadmap, createEpic)]),
                Transition(workflow, generateSpecs, "Generate milestone deep dives from EvalRoadmap prepared epic.", [Requirement(ProductIdentity.PreparedEpic)], "GenerateMilestoneDeepDivesForEpic", ExecutionPosture.OneShotAgentPrompt, [specs], [ProductIdentity.MilestoneSpecificationSet], [Effect("persist-eval-milestone-specifications", EffectCategory.ProductPersistence, [ProductIdentity.PreparedEpic], [ProductIdentity.MilestoneSpecificationSet])], [ProductDependency(ProductIdentity.PreparedEpic, createEpic, generateSpecs)], cleanInputSurfaces: [EvaluationArtifactPaths.PreparedEpic]),
                Transition(workflow, verifyPlanEntry, "Verify and publish the EvalRoadmap products that satisfy the universal planning entry contract.", [Requirement(ProductIdentity.PreparedEpic), Requirement(ProductIdentity.MilestoneSpecificationSet)], "VerifyPlanEntryContract", ExecutionPosture.ReadOnlyPrompt, [], [ProductIdentity.PreparedEpic, ProductIdentity.MilestoneSpecificationSet], [Effect("record-eval-plan-entry-evidence", EffectCategory.Evidence, [ProductIdentity.PreparedEpic, ProductIdentity.MilestoneSpecificationSet], []), Effect("publish-eval-plan-entry", EffectCategory.Publication, [ProductIdentity.PreparedEpic, ProductIdentity.MilestoneSpecificationSet], [ProductIdentity.EvaluationIntent, ProductIdentity.DependencyInventory, ProductIdentity.HypothesisInventory, ProductIdentity.ArchitecturalCatalog, ProductIdentity.EvalDag, ProductIdentity.NextEpicRoadmap, ProductIdentity.PreparedEpic, ProductIdentity.MilestoneSpecificationSet], order: 1)], [ProductDependency(ProductIdentity.PreparedEpic, createEpic, verifyPlanEntry), ProductDependency(ProductIdentity.MilestoneSpecificationSet, generateSpecs, verifyPlanEntry)]),
            ],
            [preparedEpic, specs],
    ...
    public static WorkflowDefinition CreatePlan()
    {
        ...
        ProductDefinition refinedMilestoneSet = Product(ProductIdentity.ExecutionMilestoneSet, workflow, refineDetails, downstream, "refined execution milestone set representation");
        ...
        ProductDefinition milestonePlan = Product(ProductIdentity.ExecutablePlan, workflow, generateMilestones, downstream, "milestone-linked executable plan representation");
        ...
        return new WorkflowDefinition(
            ...
            [
                ...
                Transition(workflow, runAdversarialReview, "Run the adversarial review against the executable plan and projection.", [Requirement(ProductIdentity.ExecutablePlan), Requirement(ProductIdentity.AdversarialProjection)], "RunAdversarialReview", ExecutionPosture.ReadOnlyPrompt, [adversarialReview], [ProductIdentity.AdversarialReview], [Effect("persist-adversarial-review", EffectCategory.Evidence, [ProductIdentity.ExecutablePlan, ProductIdentity.AdversarialProjection], [ProductIdentity.AdversarialReview])], [ProductDependency(ProductIdentity.AdversarialProjection, generateAdversarialProjection, runAdversarialReview)], cleanInputSurfaces: [OrchestrationArtifactPaths.Plan, OrchestrationArtifactPaths.AgentsDirectory + "/projections/"]),
                Transition(workflow, revisePlan, "Revise the executable plan using adversarial review evidence.", [Requirement(ProductIdentity.ExecutablePlan), Requirement(ProductIdentity.AdversarialReview)], "ReviewAndRevisePlan", ExecutionPosture.WarmSession, [executablePlan], [ProductIdentity.ExecutablePlan], [Effect("persist-reviewed-plan", EffectCategory.ProductPersistence, [ProductIdentity.ExecutablePlan, ProductIdentity.AdversarialReview], [ProductIdentity.ExecutablePlan])], [ProductDependency(ProductIdentity.AdversarialReview, runAdversarialReview, revisePlan)], cleanInputSurfaces: [OrchestrationArtifactPaths.Plan, OrchestrationArtifactPaths.AgentsDirectory + "/projections/"]),
                Transition(workflow, generateOperationalContext, "Generate operational context from the validated executable plan.", [Requirement(ProductIdentity.ExecutablePlan)], "SeedOperationalContext", ExecutionPosture.ScopedArtifactOperation, [operationalContext], [ProductIdentity.OperationalContext], [Effect("persist-operational-context", EffectCategory.ProductPersistence, [ProductIdentity.ExecutablePlan], [ProductIdentity.OperationalContext]), Effect("publish-agents-operational-context", EffectCategory.Publication, [ProductIdentity.OperationalContext], [ProductIdentity.OperationalContext], order: 1)], [ProductDependency(ProductIdentity.ExecutablePlan, revisePlan, generateOperationalContext)], cleanInputSurfaces: [OrchestrationArtifactPaths.Plan]),
                Transition(workflow, collectDetails, "Collect execution details needed by implementation agents.", [Requirement(ProductIdentity.ExecutablePlan), Requirement(ProductIdentity.MilestoneSpecificationSet)], "CollectDetails", ExecutionPosture.ScopedArtifactOperation, [executionDetails], [ProductIdentity.ExecutionDetails], [Effect("persist-execution-details", EffectCategory.ProductPersistence, [ProductIdentity.ExecutablePlan, ProductIdentity.MilestoneSpecificationSet], [ProductIdentity.ExecutionDetails]), Effect("publish-agents-execution-details", EffectCategory.Publication, [ProductIdentity.ExecutionDetails], [ProductIdentity.ExecutionDetails], order: 1)], [ProductDependency(ProductIdentity.ExecutablePlan, revisePlan, collectDetails)], cleanInputSurfaces: [OrchestrationArtifactPaths.Plan, OrchestrationArtifactPaths.SpecsDirectory + "/"]),
                Transition(workflow, generateMilestones, "Generate execution milestone checklists and link them from the executable plan.", [Requirement(ProductIdentity.ExecutablePlan)], "ExtractMilestones", ExecutionPosture.ScopedArtifactOperation, [milestonePlan, milestoneSet], [ProductIdentity.ExecutablePlan, ProductIdentity.ExecutionMilestoneSet], [Effect("persist-execution-milestones", EffectCategory.ProductPersistence, [ProductIdentity.ExecutablePlan], [ProductIdentity.ExecutablePlan, ProductIdentity.ExecutionMilestoneSet]), Effect("publish-agents-execution-milestones", EffectCategory.Publication, [ProductIdentity.ExecutablePlan, ProductIdentity.ExecutionMilestoneSet], [ProductIdentity.ExecutablePlan, ProductIdentity.ExecutionMilestoneSet], order: 1)], [ProductDependency(ProductIdentity.ExecutablePlan, revisePlan, generateMilestones)], cleanInputSurfaces: [OrchestrationArtifactPaths.Plan]),
                Transition(workflow, refineDetails, "Refine execution details and milestone checklists together.", [Requirement(ProductIdentity.ExecutionDetails), Requirement(ProductIdentity.ExecutionMilestoneSet)], "ExtractDetails", ExecutionPosture.ScopedArtifactOperation, [refinedDetails, refinedMilestoneSet], [ProductIdentity.ExecutionDetails, ProductIdentity.ExecutionMilestoneSet], [Effect("persist-refined-execution-details", EffectCategory.ProductPersistence, [ProductIdentity.ExecutionDetails, ProductIdentity.ExecutionMilestoneSet], [ProductIdentity.ExecutionDetails, ProductIdentity.ExecutionMilestoneSet]), Effect("publish-agents-refined-details", EffectCategory.Publication, [ProductIdentity.ExecutionDetails, ProductIdentity.ExecutionMilestoneSet], [ProductIdentity.ExecutionDetails, ProductIdentity.ExecutionMilestoneSet], order: 1)], [ProductDependency(ProductIdentity.ExecutionDetails, collectDetails, refineDetails), ProductDependency(ProductIdentity.ExecutionMilestoneSet, generateMilestones, refineDetails)], cleanInputSurfaces: [OrchestrationArtifactPaths.Details, OrchestrationArtifactPaths.MilestonesDirectory + "/"]),
    ...
    public static WorkflowDefinition CreateExecute()
    {
        ...
        ProductDefinition updatedMilestoneSet = Product(ProductIdentity.ExecutionMilestoneSet, workflow, executeSlice, workflow, "updated execution milestone set representation");
        ...
        return new WorkflowDefinition(
            ...
            [
                ...
                Stage("Implementation", "Execute one implementation slice, update milestone progress, and record repository evidence.", [Requirement(ProductIdentity.DecisionSet), Requirement(ProductIdentity.ExecutionMilestoneSet)], [ProductIdentity.ImplementationSlice, ProductIdentity.RepositoryChanges, ProductIdentity.ExecutionMilestoneSet], [ProductDependency(ProductIdentity.DecisionSet, generateDecision, executeSlice), ProductDependency(ProductIdentity.ExecutionMilestoneSet, verifyReadiness, executeSlice)], [executeSlice], ["Execution Continuity"]),
            ...
            [
                ...
                Transition(workflow, executeSlice, "Execute the selected implementation slice, update its milestone progress, and capture repository delta.", [Requirement(ProductIdentity.DecisionSet), Requirement(ProductIdentity.ExecutionMilestoneSet)], "ExecuteImplementationSlice", ExecutionPosture.WarmSession, [implementationSlice, repositoryChanges, updatedMilestoneSet], [ProductIdentity.ImplementationSlice, ProductIdentity.RepositoryChanges, ProductIdentity.ExecutionMilestoneSet], [Effect("record-implementation-slice", EffectCategory.Evidence, [ProductIdentity.DecisionSet, ProductIdentity.ExecutionMilestoneSet], [ProductIdentity.ImplementationSlice, ProductIdentity.RepositoryChanges, ProductIdentity.ExecutionMilestoneSet])], [ProductDependency(ProductIdentity.DecisionSet, generateDecision, executeSlice), ProductDependency(ProductIdentity.ExecutionMilestoneSet, verifyReadiness, executeSlice)]),
    ...
    private static WorkflowTransitionDefinition Transition(
        ...
        IReadOnlyList<TransitionDependency> dependencies,
        IReadOnlyList<string>? cleanInputSurfaces = null)
    {
        GateDefinition inputGate = Gate(
            $"{identity}.Input",
            $"Required input products for {identity}.",
            inputs.Select(input => input.Product).ToArray());
        if (cleanInputSurfaces is { Count: > 0 })
        {
            // A single surface keeps the original "{id}.CleanInput" identity (WriteExecutablePlan's
            // first declaration is owner-visible); several surfaces qualify each identity by surface.
            inputGate = inputGate with
            {
                Requirements =
                [
                    .. inputGate.Requirements,
                    .. cleanInputSurfaces.Select(surface => new GateRequirementDefinition(
                        cleanInputSurfaces.Count == 1
                            ? $"{identity}.CleanInput"
                            : $"{identity}.CleanInput:{surface}",
                        $"Working tree under '{surface}' is committed before {identity} reads it.",
                        null,
