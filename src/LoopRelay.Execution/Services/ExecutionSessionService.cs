...
public sealed class ExecutionSessionService(
    IImplementationExecutionContextService ImplementationExecutionContextService,
    ...
    IDecisionInfluenceService? decisionInfluenceService = null) : IExecutionSessionService
{
    ...
    public async Task<ExecutionSessionSummary> StartAsync(Guid repositoryId, ExecutionStartRequest request)
    {
        ...
        try
        {
            ...
            ImplementationExecutionContext context = await ImplementationExecutionContextService.BuildContextAsync(repositoryId);
    ...
    private static ExecutionPromptManifest BuildPromptManifest(
        Guid sessionId,
        ImplementationExecutionContext context,
    ...
    private static string? FindDeliveredPath(ImplementationExecutionContext context, string role)
    {
