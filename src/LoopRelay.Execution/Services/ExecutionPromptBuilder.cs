...
/// <summary>
/// Renders the operational execution prompt from the <c>LoopRelay.Core.Prompts</c> catalog —
...
public sealed class ExecutionPromptBuilder : IExecutionPromptBuilder
{
    ...
    public ExecutionPrompt Build(ImplementationExecutionContext context)
    {
