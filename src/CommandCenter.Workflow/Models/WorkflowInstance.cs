...
public sealed record WorkflowInstance(
    ...
    WorkflowGitProjection CurrentGit,
    WorkflowGitStatus GitCommitStatus,
    WorkflowGitStatus GitPushStatus,
    bool HasPendingGitChanges,
    bool HasUnpushedGitChanges,
    WorkflowCompletionEvaluation CompletionEvaluation,
    WorkflowGitDiagnostics GitDiagnostics,
