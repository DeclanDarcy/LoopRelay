...
Objective: establish terminology, settings, prompt-policy composition, minimal ledger ownership, and review runner boundaries before implementing the full loop.
...
Objective: inject centralized implementation-first guidance into planning, execution, decision, roadmap, and completion prompts while capturing explicit HITL non-implementation requests early.
