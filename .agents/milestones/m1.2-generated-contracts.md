...
- The executable path is Oracle fixture -> canonical generation IR -> generated TypeScript contract metadata -> freshness manifest.
- No manual TypeScript consumer, Rust shell mirror, dev Tauri mock, API wrapper, or UI import has been migrated by this slice.
- The generated artifact is intentionally metadata-only; full generated consumer types remain later M1.2 work after the pipeline is proven.
