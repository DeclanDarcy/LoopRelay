...
- [x] Previous handoff snapshot is archived with next sequence number.
- [x] No historical handoff is created when no previous handoff existed.
- [x] Rotation/archive failure transitions to `Failed`.
