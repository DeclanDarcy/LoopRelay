...
- [x] Add contract models under `src/LoopRelay.Orchestration.Primitives/Workflows`:
  - [x] `WorkflowIdentity`
  - [x] `WorkflowChainDefinition`
  - [x] `WorkflowDefinition`
  - [x] `WorkflowStageDefinition`
  - [x] `WorkflowTransitionDefinition`
  - [x] `TransitionDependency`
  - [x] `ProductDefinition`
  - [x] `ProductIdentity`
  - [x] `ProductRequirement`
  - [x] `GateDefinition`
  - [x] `GateResult`
  - [x] `GateRequirementResult`
  - [x] `WorkflowOutcome`
  - [x] `StageOutcome`
  - [x] `TransitionOutcome`
  - [x] `ExecutionPosture`
  - [x] `EffectDefinition`
  - [x] `BlockerDefinition`
  - [x] `RecoveryDefinition`
- [x] Model gate outcomes as structured results:
  - [x] `Satisfied`
  - [x] `Unsatisfied`
  - [x] `Blocked`
  - [x] `Waiting`
  - [x] `Invalid`
  - [x] `Ambiguous`
- [x] Model runtime outcomes as structured results:
  - [x] `Completed`
  - [x] `Paused`
  - [x] `Blocked`
  - [x] `Failed`
  ...
  - [x] `Stalled`
  - [x] `Ambiguous`
- [x] Model dependencies as required, optional, advisory, freshness-sensitive, or invalidating.
- [x] Add workflow definition validation that checks:
  - [x] Identity is explicit.
  - [x] Stages reference known transitions.
  - [x] Transition dependencies reference known products or transitions.
  - [x] Products have producer/consumer metadata.
  - [x] Entry and exit gates have explainable requirements.
  - [x] Workflow definitions do not embed CLI or persistence implementation details.
- [x] Add non-wired definition sketches for all four workflows to prove the contracts fit the domain.
- [x] Ensure the definition sketches do not drive production execution yet.
...
- [x] New tests in `tests/LoopRelay.Orchestration.Primitives.Tests` validate contract invariants.
- [x] All four workflow definitions can be represented through the same contract types.
- [x] Existing CLI and workflow tests still pass.
