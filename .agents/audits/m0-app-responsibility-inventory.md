...
| Operational-context proposal review | Workflow coordination plus local draft/review state and backend mutation gating. | Retain review controls, draft fields, decision review, and comparison rendering in `App.tsx` unless a later audit proves another presentation-only boundary. |
