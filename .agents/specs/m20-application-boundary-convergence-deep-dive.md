<!-- BEGIN GENERATED: source=.agents/specs/epic.md version=3.0 milestone=M20 -->
...
|---|---|---|
| Roadmap authority | [`.agents/specs/epic.md`](epic.md) §§0, 2.1, 3, 5, 6, 7, 8, 9 (M20), 10–12, Appendix A | Status, ownership, dependency order, permanent property, convergence and acceptance |
