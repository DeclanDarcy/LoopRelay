<!-- BEGIN GENERATED: source=.agents/epic.md version=3.0 milestone=M15 -->
...
|---|---|---|
| Roadmap authority | [`.agents/epic.md`](../epic.md) §§0, 2.1, 3, 5, 6, 7, 8, 9 (M15), 10–12, Appendix A | Status, ownership, dependency order, permanent property, convergence and acceptance |
